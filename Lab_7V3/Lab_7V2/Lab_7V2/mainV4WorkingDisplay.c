...
ISR(TIMER1_OVF_vect)
{
	...
	uint8_t val_digit = val / (pow(10, strobeDig));  //choose value based on currently displayed digit, cdd counts up and resets to 0 after 3, cdd = 0 = first digit
